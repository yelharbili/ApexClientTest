...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(4040194319837278)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4040410069837279)
,p_plugin_id=>wwv_flow_imp.id(4040194319837278)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4040767795837279)
,p_plugin_attribute_id=>wwv_flow_imp.id(4040410069837279)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4041136275837281)
,p_plugin_attribute_id=>wwv_flow_imp.id(4040410069837279)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4041500251837281)
,p_plugin_attribute_id=>wwv_flow_imp.id(4040410069837279)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4041948170837281)
,p_plugin_id=>wwv_flow_imp.id(4040194319837278)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(4040410069837279)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4042286326837282)
,p_plugin_id=>wwv_flow_imp.id(4040194319837278)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4042506280837282)
,p_plugin_id=>wwv_flow_imp.id(4040194319837278)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4042816952837282)
,p_plugin_id=>wwv_flow_imp.id(4040194319837278)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4043186859837282)
,p_plugin_id=>wwv_flow_imp.id(4040194319837278)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4043432180837284)
,p_plugin_attribute_id=>wwv_flow_imp.id(4043186859837282)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4043825513837284)
,p_plugin_attribute_id=>wwv_flow_imp.id(4043186859837282)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4044282111837284)
,p_plugin_attribute_id=>wwv_flow_imp.id(4043186859837282)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4044677556837285)
,p_plugin_attribute_id=>wwv_flow_imp.id(4043186859837282)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4045025101837285)
,p_plugin_id=>wwv_flow_imp.id(4040194319837278)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4045345960837285)
,p_plugin_attribute_id=>wwv_flow_imp.id(4045025101837285)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4045748790837285)
,p_plugin_attribute_id=>wwv_flow_imp.id(4045025101837285)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4046100664837287)
,p_plugin_attribute_id=>wwv_flow_imp.id(4045025101837285)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4046511516837287)
,p_plugin_attribute_id=>wwv_flow_imp.id(4045025101837285)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4046957598837287)
,p_plugin_attribute_id=>wwv_flow_imp.id(4045025101837285)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4047363446837287)
,p_plugin_attribute_id=>wwv_flow_imp.id(4045025101837285)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4047785314837287)
,p_plugin_attribute_id=>wwv_flow_imp.id(4045025101837285)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4048152206837290)
,p_plugin_id=>wwv_flow_imp.id(4040194319837278)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1804091062457951031)
,p_plugin_id=>wwv_flow_imp.id(4040194319837278)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
