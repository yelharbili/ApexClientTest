...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(4013459146837121)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1931251315773908830)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1931250760761908829)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1674358697031635316)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4014338718837168)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4014607704837175)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4014943341837176)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4015239249837178)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4015543921837179)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4015804263837179)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4016182764837181)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(4015543921837179)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1931251315773908830)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4016400020837182)
,p_plugin_attribute_id=>wwv_flow_imp.id(4016182764837181)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4016888200837184)
,p_plugin_attribute_id=>wwv_flow_imp.id(4016182764837181)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4017266355837185)
,p_plugin_attribute_id=>wwv_flow_imp.id(4016182764837181)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4017696602837185)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(4016182764837181)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4017963983837187)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4018252786837187)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4018585460837187)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4018870941837189)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4019169606837196)
,p_plugin_attribute_id=>wwv_flow_imp.id(4018870941837189)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4019559620837198)
,p_plugin_attribute_id=>wwv_flow_imp.id(4018870941837189)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4019998199837198)
,p_plugin_attribute_id=>wwv_flow_imp.id(4018870941837189)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4020347917837198)
,p_plugin_attribute_id=>wwv_flow_imp.id(4018870941837189)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4020747520837200)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(4015804263837179)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1931250760761908829)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4021089347837200)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4021324337837201)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4021614059837201)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4021937391837201)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4022239372837203)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4022557240837203)
,p_plugin_attribute_id=>wwv_flow_imp.id(4022239372837203)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4022940009837204)
,p_plugin_attribute_id=>wwv_flow_imp.id(4022239372837203)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4023381962837204)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4023684085837206)
,p_plugin_attribute_id=>wwv_flow_imp.id(4023381962837204)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4024068932837207)
,p_plugin_attribute_id=>wwv_flow_imp.id(4023381962837204)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4024467722837207)
,p_plugin_attribute_id=>wwv_flow_imp.id(4023381962837204)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4024844298837209)
,p_plugin_attribute_id=>wwv_flow_imp.id(4023381962837204)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4025214098837209)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4025521433837210)
,p_plugin_attribute_id=>wwv_flow_imp.id(4025214098837209)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4025916243837212)
,p_plugin_attribute_id=>wwv_flow_imp.id(4025214098837209)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4026315696837212)
,p_plugin_attribute_id=>wwv_flow_imp.id(4025214098837209)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4026779566837214)
,p_plugin_attribute_id=>wwv_flow_imp.id(4025214098837209)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4027190151837215)
,p_plugin_attribute_id=>wwv_flow_imp.id(4025214098837209)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4027582892837215)
,p_plugin_attribute_id=>wwv_flow_imp.id(4025214098837209)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4027958617837217)
,p_plugin_attribute_id=>wwv_flow_imp.id(4025214098837209)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4028303021837217)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4028647621837218)
,p_plugin_attribute_id=>wwv_flow_imp.id(4028303021837217)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4029094089837218)
,p_plugin_attribute_id=>wwv_flow_imp.id(4028303021837217)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4029458940837220)
,p_plugin_attribute_id=>wwv_flow_imp.id(4028303021837217)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4029802781837220)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4030116904837221)
,p_plugin_attribute_id=>wwv_flow_imp.id(4029802781837220)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4030540344837221)
,p_plugin_attribute_id=>wwv_flow_imp.id(4029802781837220)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4030985480837223)
,p_plugin_attribute_id=>wwv_flow_imp.id(4029802781837220)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4031317615837223)
,p_plugin_attribute_id=>wwv_flow_imp.id(4029802781837220)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4031776448837223)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4032066024837225)
,p_plugin_attribute_id=>wwv_flow_imp.id(4031776448837223)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4032458522837225)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4032711079837226)
,p_plugin_attribute_id=>wwv_flow_imp.id(4032458522837225)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4033101177837226)
,p_plugin_attribute_id=>wwv_flow_imp.id(4032458522837225)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4033506566837228)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1674358697031635316)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4033831917837228)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(4034105057837229)
,p_plugin_attribute_id=>wwv_flow_imp.id(4033831917837228)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4034571033837231)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4034899162837232)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1812465205989730444)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1812466465509734592)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1515513691093972014)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1798871577315323711)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1799550878045406815)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1812463270922685458)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1812464604312699315)
,p_plugin_id=>wwv_flow_imp.id(4013459146837121)
