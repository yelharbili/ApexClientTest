prompt --application/shared_components/user_interface/templates/report/premium_profile_dynamic
begin
--   Manifest
--     ROW TEMPLATE: PREMIUM_PROFILE_DYNAMIC
--   Manifest End
...
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(4453638130858851)
,p_row_template_name=>'Premium Profile Dynamic'
,p_internal_name=>'PREMIUM_PROFILE_DYNAMIC'
