...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3930549211837028)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3930820968837028)
,p_plug_template_id=>wwv_flow_imp.id(3930549211837028)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3931112095837028)
,p_plug_template_id=>wwv_flow_imp.id(3930549211837028)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3931444167837028)
,p_plug_template_id=>wwv_flow_imp.id(3930549211837028)
,p_name=>'Button Start'
