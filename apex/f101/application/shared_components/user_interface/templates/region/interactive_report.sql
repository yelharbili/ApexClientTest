...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3928403755837028)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3928764688837028)
,p_plug_template_id=>wwv_flow_imp.id(3928403755837028)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3929067702837028)
,p_plug_template_id=>wwv_flow_imp.id(3928403755837028)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3929353047837028)
,p_plug_template_id=>wwv_flow_imp.id(3928403755837028)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3929664167837028)
,p_plug_template_id=>wwv_flow_imp.id(3928403755837028)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3929933190837028)
,p_plug_template_id=>wwv_flow_imp.id(3928403755837028)
,p_name=>'Sub Regions'
