...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3923081063837025)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3923318201837025)
,p_plug_template_id=>wwv_flow_imp.id(3923081063837025)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3923670763837026)
,p_plug_template_id=>wwv_flow_imp.id(3923081063837025)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3923942778837026)
,p_plug_template_id=>wwv_flow_imp.id(3923081063837025)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3924267565837026)
,p_plug_template_id=>wwv_flow_imp.id(3923081063837025)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3924528716837026)
,p_plug_template_id=>wwv_flow_imp.id(3923081063837025)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3924802633837026)
,p_plug_template_id=>wwv_flow_imp.id(3923081063837025)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3925123618837026)
,p_plug_template_id=>wwv_flow_imp.id(3923081063837025)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3925400509837026)
,p_plug_template_id=>wwv_flow_imp.id(3923081063837025)
,p_name=>'Sub Regions'
