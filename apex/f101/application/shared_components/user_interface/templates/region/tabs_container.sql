...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3948014002837035)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3948391440837035)
,p_plug_template_id=>wwv_flow_imp.id(3948014002837035)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3948620483837037)
,p_plug_template_id=>wwv_flow_imp.id(3948014002837035)
,p_name=>'Tabs'
