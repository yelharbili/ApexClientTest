...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3878717126836993)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3879087961836993)
,p_plug_template_id=>wwv_flow_imp.id(3878717126836993)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3879332112836995)
,p_plug_template_id=>wwv_flow_imp.id(3878717126836993)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3879623096836995)
,p_plug_template_id=>wwv_flow_imp.id(3878717126836993)
,p_name=>'Sub Regions'
