...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3900313347837014)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3900609399837014)
,p_plug_template_id=>wwv_flow_imp.id(3900313347837014)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3900907748837014)
,p_plug_template_id=>wwv_flow_imp.id(3900313347837014)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3901269694837014)
,p_plug_template_id=>wwv_flow_imp.id(3900313347837014)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3901575398837014)
,p_plug_template_id=>wwv_flow_imp.id(3900313347837014)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3901827064837014)
,p_plug_template_id=>wwv_flow_imp.id(3900313347837014)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3902142373837015)
,p_plug_template_id=>wwv_flow_imp.id(3900313347837014)
,p_name=>'Sub Regions'
