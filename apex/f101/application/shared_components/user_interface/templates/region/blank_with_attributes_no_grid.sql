...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3873082184836990)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3873358520836992)
,p_plug_template_id=>wwv_flow_imp.id(3873082184836990)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3873618245836992)
,p_plug_template_id=>wwv_flow_imp.id(3873082184836990)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3873990906836992)
,p_plug_template_id=>wwv_flow_imp.id(3873082184836990)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3874266821836992)
,p_plug_template_id=>wwv_flow_imp.id(3873082184836990)
,p_name=>'Sub Regions'
