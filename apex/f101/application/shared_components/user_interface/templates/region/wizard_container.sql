...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3955740348837040)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3956069877837040)
,p_plug_template_id=>wwv_flow_imp.id(3955740348837040)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3956311396837040)
,p_plug_template_id=>wwv_flow_imp.id(3955740348837040)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3956653234837040)
,p_plug_template_id=>wwv_flow_imp.id(3955740348837040)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3956983506837040)
,p_plug_template_id=>wwv_flow_imp.id(3955740348837040)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3957285577837040)
,p_plug_template_id=>wwv_flow_imp.id(3955740348837040)
