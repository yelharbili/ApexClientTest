...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3935594123837031)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3935878032837031)
,p_plug_template_id=>wwv_flow_imp.id(3935594123837031)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3936136578837031)
,p_plug_template_id=>wwv_flow_imp.id(3935594123837031)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3936464347837031)
,p_plug_template_id=>wwv_flow_imp.id(3935594123837031)
,p_name=>'Sub Regions'
