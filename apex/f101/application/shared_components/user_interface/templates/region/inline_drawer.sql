...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3918446757837023)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3918780417837023)
,p_plug_template_id=>wwv_flow_imp.id(3918446757837023)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3919027678837023)
,p_plug_template_id=>wwv_flow_imp.id(3918446757837023)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3919380375837023)
,p_plug_template_id=>wwv_flow_imp.id(3918446757837023)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3919634284837025)
,p_plug_template_id=>wwv_flow_imp.id(3918446757837023)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3919931114837025)
,p_plug_template_id=>wwv_flow_imp.id(3918446757837023)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3920220120837025)
,p_plug_template_id=>wwv_flow_imp.id(3918446757837023)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3920544272837025)
,p_plug_template_id=>wwv_flow_imp.id(3918446757837023)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3920801772837025)
,p_plug_template_id=>wwv_flow_imp.id(3918446757837023)
,p_name=>'Sub Regions'
