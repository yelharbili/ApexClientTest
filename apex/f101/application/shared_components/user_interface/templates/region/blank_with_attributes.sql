...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3871649564836990)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3871923480836990)
,p_plug_template_id=>wwv_flow_imp.id(3871649564836990)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3872241911836990)
,p_plug_template_id=>wwv_flow_imp.id(3871649564836990)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3872501353836990)
,p_plug_template_id=>wwv_flow_imp.id(3871649564836990)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3872887708836990)
,p_plug_template_id=>wwv_flow_imp.id(3871649564836990)
,p_name=>'Sub Regions'
