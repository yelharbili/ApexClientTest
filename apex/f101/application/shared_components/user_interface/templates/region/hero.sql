...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3904942026837015)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3905216990837017)
,p_plug_template_id=>wwv_flow_imp.id(3904942026837015)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3905577846837017)
,p_plug_template_id=>wwv_flow_imp.id(3904942026837015)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3905812386837017)
,p_plug_template_id=>wwv_flow_imp.id(3904942026837015)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3906149342837017)
,p_plug_template_id=>wwv_flow_imp.id(3904942026837015)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3906421372837018)
,p_plug_template_id=>wwv_flow_imp.id(3904942026837015)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
