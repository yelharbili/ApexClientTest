...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3933003802837029)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3933302608837029)
,p_plug_template_id=>wwv_flow_imp.id(3933003802837029)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3933658841837029)
,p_plug_template_id=>wwv_flow_imp.id(3933003802837029)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3933966793837029)
,p_plug_template_id=>wwv_flow_imp.id(3933003802837029)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3934232928837031)
,p_plug_template_id=>wwv_flow_imp.id(3933003802837029)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3934514896837031)
,p_plug_template_id=>wwv_flow_imp.id(3933003802837029)
,p_name=>'Sub Regions'
