...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3913879267837021)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3914170242837021)
,p_plug_template_id=>wwv_flow_imp.id(3913879267837021)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3914475595837021)
,p_plug_template_id=>wwv_flow_imp.id(3913879267837021)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3914741617837021)
,p_plug_template_id=>wwv_flow_imp.id(3913879267837021)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3915061961837021)
,p_plug_template_id=>wwv_flow_imp.id(3913879267837021)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3915317883837021)
,p_plug_template_id=>wwv_flow_imp.id(3913879267837021)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3915657517837021)
,p_plug_template_id=>wwv_flow_imp.id(3913879267837021)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3915975068837021)
,p_plug_template_id=>wwv_flow_imp.id(3913879267837021)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3916206761837021)
,p_plug_template_id=>wwv_flow_imp.id(3913879267837021)
,p_name=>'Sub Regions'
